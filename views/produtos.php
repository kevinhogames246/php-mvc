...
<body>
    ...
    <div class="div_voltar">
        <a class="case-button" tabindex="-1"
            href="../controllers/Ajax.php?voutar=<?= ".." . str_replace("/", "~", explode($_SESSION['uri'], $_SERVER['HTTP_REFERER'])[1]) ?>">
    ...
    <section class="container">
        <!-- <div class="div_pesq_cadastro">
            <div class="label-float">
                <input class="red-2" id="busca" placeholder=" " type="text" <?= (isset($_GET['codigo'])) ? 'value="' . $codigo = $_GET['codigo'] . '"' ?? '' : '' ?>>
            ...
            <div class="select">
                <select id="campo">
                    <option value="p.codigo" <?= (isset($_GET['campo']) && $_GET['campo'] == '2') ? 'selected' : '' ?>>
                        C. Produto</option>
                    <option value="p.nome">N. Produto</option>
                </select>
            </div>
