            ...
            <div class="select">
                <select id="campo">
                    ...
                    <option value="p.codigo" <?= (isset($_GET['campo']) && $_GET['campo'] == '2') ? 'selected' : '' ?>>
                        ...
                        <option value="u.usuario">Usuario</option>
                        <option value="m.tipo">Tipo</option>
                </select>
            </div>
            <div onclick="searchMov()" class="case-button"><button class="red-2">Search</button></div>
        </div>
        <div class="pageInput">
            <div class="case-button">
                ...
                <input class="red-1" type="number" id="page" onchange="searchMov()" value="1">
                <div class="case-button">
