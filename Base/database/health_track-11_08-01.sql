...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 08-Nov-2023 às 15:25
...
CREATE TABLE IF NOT EXISTS `pessoas` (
  ...
  `fk_idUniSaude` int(11) DEFAULT NULL,
...
(66, 'Osmar Albino Cardoso', 'osmar@teste.com', '$2y$10$RdODEuIdgIpjtiJVcsdAN.SuqhGdA8vnu65FD3JEzkpQ3vh53VKfG', 'user', '', '', '', '0000-00-00', 1),
...
CREATE TABLE IF NOT EXISTS `procedimentos` (
  ...
  `condicaoProcedimento` varchar(10) DEFAULT 'Pendente',
  `statusHistorico` varchar(20) NOT NULL,
  `iconeProcedimento` int(11) NOT NULL,
...
INSERT INTO `procedimentos` (`idProcedimento`, `dataHoraProcedimento`, `condicaoProcedimento`, `statusHistorico`, `iconeProcedimento`, `remedioProcedimento`, `obsMedicas`, `nomeProcedimento`, `descProcedimento`, `fk_idProcesso`, `fk_idProcedimento`, `fk_idUniSaude`, `fk_idFuncionario`) VALUES
(1, '28_10', 'Concluido', 'bom', 0, NULL, NULL, '', NULL, 1, 1, 1, 1),
(2, '29_10', 'Pendente', 'bom', 0, NULL, NULL, '', NULL, 2, 1, 1, 1),
(3, '30_10', 'Pendente', 'bom', 0, NULL, NULL, '', NULL, 1, 1, 1, 1),
(4, '31_10', 'Pendente', 'bom', 0, NULL, NULL, '', NULL, 1, 1, 1, 2);
